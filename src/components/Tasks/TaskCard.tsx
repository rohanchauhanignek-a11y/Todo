  ...
  return (
    <div className="bg-none h-full w-1/2 border-[0.5px] border-gray-500 rounded-lg p-4 justify-between  hover:bg-neutral-700 hover:text-white flex">
      <div className="flex gap-4">
        <input type="checkbox" className="w-4 h-4 text-green-600 bg-neutral-secondary-medium border-default-medium rounded-xs focus:ring-green-500 dark:focus:ring-green-600 ring-offset-neutral-primary focus:ring-2 cursor-pointer" checked={task.taskStatus} onChange={() =>{ taskUpdate(task.id,task.taskStatus);}}/>
